...
| `models/qwen35/serving-benchmark-snapshot-plan.md` | Plan for a retained Qwen3.5-4B HTTP serving benchmark snapshot: same-GPU OpenInfer/vLLM runs, fixed-shape probes, QPS or concurrency sweep, output sanity, unsupported-cell retention, and follow-up routing for measured bottlenecks. |
